 ...
 * @version 0.6.3
 * 
 * update by Corinne 8/16/2016 to use a TabJTable
 */
public class ColumnPopupMenu extends JPopupMenu{
     ...
     */
    public ColumnPopupMenu(TabJTable table){
        initComponents();
        this.table = table;
    ...
    public void showPopupMenu(MouseEvent e) {
        ...
        Rectangle headerRect = header.getHeaderRect(vColumnIndex);
        if (vColumnIndex == 0) {
            headerRect.width -= 2;
        } else {
            headerRect.grow(-2, 0);
    ...
    public void applyChecksToFilteredItems(int col){
        ...
        // get filtered items
        ArrayList<Object> fItems = table.getFilterItems().get(col);
    ...
    public void applyColumnFilter(int columnIndex) {
        ...
        table.filterByItems(columnIndex, filterItems);
